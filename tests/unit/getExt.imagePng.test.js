...
describe('GET /v1/fragments/:id.ext - PNG image conversions', () => {
  let fragmentId;
  const user = { email: 'user1@email.com', password: 'password1' };
  const imagePath = path.join(__dirname, '../images/test.png'); // ensure this image exists
