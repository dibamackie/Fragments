...
describe('POST /v1/fragments', () => {
  ...
  // Test case: Invalid body format, expected raw binary data. - image/jpeg (Invalid)
  test('image/jpeg content type returns 400', () =>
    request(app)
      .post('/v1/fragments')
      .auth('user1@email.com', 'password1')
      .set('Content-Type', 'image/jpeg') // Invalid body format, expected raw binary data.
      .send('This is an image fragment')
